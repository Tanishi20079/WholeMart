...
public class treseme extends Composite  {

	private static tresemeUiBinder uiBinder = GWT.create(tresemeUiBinder.class);
	GreetingServiceAsync a1 = GWT.create(GreetingService.class);


	interface tresemeUiBinder extends UiBinder<Widget, treseme> {
	}

	public treseme() {
		initWidget(uiBinder.createAndBindUi(this));
a1.FetchTreseme( new AsyncCallback<String>() {
