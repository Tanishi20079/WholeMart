...
public class sunsilk extends Composite  {

	private static sunsilkUiBinder uiBinder = GWT.create(sunsilkUiBinder.class);
	GreetingServiceAsync a1 = GWT.create(GreetingService.class);

	interface sunsilkUiBinder extends UiBinder<Widget, sunsilk> {
	}

	public sunsilk() {
		initWidget(uiBinder.createAndBindUi(this));
a1.FetchSunsilk( new AsyncCallback<String>() {
