...
public class dove extends Composite {

	private static doveUiBinder uiBinder = GWT.create(doveUiBinder.class);
	GreetingServiceAsync a1 = GWT.create(GreetingService.class);


	interface doveUiBinder extends UiBinder<Widget, dove> {
	}

	public dove() {
		initWidget(uiBinder.createAndBindUi(this));
a1.FetchDove( new AsyncCallback<String>() {
